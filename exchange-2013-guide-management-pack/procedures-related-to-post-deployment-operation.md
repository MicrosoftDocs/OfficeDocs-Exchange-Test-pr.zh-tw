...
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dn198286(v=EXCHG.150)
ms:contentKeyID: 54652655
ms.date: 08/29/2014
...
This topic contains the procedures that you can use as a reference when managing the Exchange Server 2013 Management Pack. For procedures related to deployment, see [與部署相關的程序](procedures-related-to-deployment.md).
...
![正在停用 SCOM 主控台中的警示](images/Dn198286.1c4f15b5-4978-4442-b26b-cc65ba577c9c(EXCHG.150).png "正在停用 SCOM 主控台中的警示")
...
See the following topics for more information about the cmdlets you can use to configure monitoring overrides.
  ...
  - [Get-MonitoringItemIdentity](https://technet.microsoft.com/zh-tw/library/jj218668\(v=exchg.150\))
