---
title: '安全群組建立與成員資格的角色: Exchange 2013 Help'
TOCTitle: 安全群組建立與成員資格的角色
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 50472837
ms.date: 05/21/2018
...
如需詳細資訊，請參閱[了解分割權限](understanding-split-permissions-exchange-2013-help.md)。
