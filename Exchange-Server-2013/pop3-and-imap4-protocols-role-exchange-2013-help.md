---
title: 'POP3 與 IMAP4 通訊協定的角色: Exchange 2013 Help'
TOCTitle: POP3 與 IMAP4 通訊協定的角色
ms:assetid: 67dd66e0-3cca-4f87-8165-4918519b39b6
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876898(v=EXCHG.150)
ms:contentKeyID: 50473380
ms.date: 05/21/2018
...
`POP3 and IMAP4 Protocols`管理角色可讓系統管理員管理 POP3 和 IMAP4 設定，例如驗證和連線設定個別伺服器上。
