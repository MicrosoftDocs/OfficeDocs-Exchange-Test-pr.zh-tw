---
title: 'UM 提示角色: Exchange 2013 Help'
TOCTitle: UM 提示角色
ms:assetid: 262928e8-b938-404f-b941-a636f4d18169
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876861(v=EXCHG.150)
ms:contentKeyID: 50472734
ms.date: 05/21/2018
...
`UM Prompts` 管理角色可讓系統管理員在組織中，建立和管理自訂的整合通訊語音提示。
