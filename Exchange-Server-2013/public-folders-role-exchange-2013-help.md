---
title: '公用資料夾角色: Exchange 2013 Help'
TOCTitle: 公用資料夾角色
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 50474044
ms.date: 05/21/2018
...
`Public Folders ` 管理角色能讓系統管理員管理組織中的公用資料夾。

此角色不會讓您管理是否適用於公用資料夾擁有郵件功能。若要啟用郵件功能或停用的公用資料夾，您必須指派`Mail Enabled Public Folders `角色相關聯的角色。如需詳細資訊，請參閱[擁有郵件功能的公用資料夾角色](mail-enabled-public-folders-role-exchange-2013-help.md)。
