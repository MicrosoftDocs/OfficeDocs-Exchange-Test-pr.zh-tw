---
title: '信箱匯入匯出角色: Exchange 2013 Help'
TOCTitle: 信箱匯入匯出角色
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 50474356
ms.date: 05/21/2018
...
`Mailbox Import Export` 管理角色可讓系統管理員匯入及匯出信箱內容，並清除信箱中不想要的內容。
