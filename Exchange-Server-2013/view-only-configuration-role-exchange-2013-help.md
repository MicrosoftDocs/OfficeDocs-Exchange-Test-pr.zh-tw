---
title: '僅檢視設定角色: Exchange 2013 Help'
TOCTitle: 僅檢視設定角色
ms:assetid: 72607063-7f2d-4b3e-a2a9-27eb88e1e16a
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876907(v=EXCHG.150)
ms:contentKeyID: 50473479
ms.date: 05/21/2018
...
此角色可以結合與建立能夠檢視組織中的每個物件的角色群組的`View-Only Recipients`角色相關聯的角色。如需詳細資訊，請參閱[僅檢視收件者角色](view-only-recipients-role-exchange-2013-help.md)。
