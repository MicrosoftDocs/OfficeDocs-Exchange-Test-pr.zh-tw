---
title: '資訊版權管理角色: Exchange 2013 Help'
TOCTitle: 資訊版權管理角色
ms:assetid: bb40c2ec-1eb8-43d4-af7c-4fa74c7c3ce2
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876934(v=EXCHG.150)
ms:contentKeyID: 50474114
ms.date: 05/21/2018
...
`Information Rights Management` 管理角色可讓系統管理員管理組織中 Exchange 的資訊版權管理 (IRM) 功能。
