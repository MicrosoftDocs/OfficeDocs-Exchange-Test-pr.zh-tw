---
title: 'Exchange 連接器角色: Exchange 2013 Help'
TOCTitle: Exchange 連接器角色
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50473495
ms.date: 05/21/2018
...
`Exchange Connectors` 管理角色可讓系統管理員建立、修改、檢視和移除傳遞代理程式連接器。

這個角色無法用來管理傳送及接收連接器。若要管理傳送和接收連接器，請使用傳送連接器和接收連接器角色。如需詳細資訊，請參閱：
