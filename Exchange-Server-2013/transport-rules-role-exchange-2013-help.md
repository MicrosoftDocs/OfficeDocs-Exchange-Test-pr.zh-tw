---
title: '傳輸規則角色: Exchange 2013 Help'
TOCTitle: 傳輸規則角色
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 50473122
ms.date: 05/21/2018
...
`Transport Rules` 管理角色可讓系統管理員管理組織中的傳輸規則。
