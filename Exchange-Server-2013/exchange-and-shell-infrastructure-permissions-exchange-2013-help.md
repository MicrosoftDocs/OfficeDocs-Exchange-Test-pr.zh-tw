---
title: 'Exchange 及命令介面基礎結構權限: Exchange 2013 Help'
TOCTitle: Exchange 及命令介面基礎結構權限
ms:assetid: 3646a4e8-36b2-41fb-89a4-79b0963fcb11
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd638114(v=EXCHG.150)
ms:contentKeyID: 50472966
ms.date: 05/21/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Exchange 及命令介面基礎結構權限
...
下表列出執行設定一般 Exchange 2013 設定之工作所需的權限。
...
<tr class="even">
<td><p>寫入稽核記錄檔</p></td>
<td><p>身為任何角色群組成員的使用者，或受指派任何管理角色的使用者，皆可寫入系統管理員稽核記錄檔。</p></td>
</tr>
</tbody>
</table>
...
下表列出執行設定控制 Exchange 管理命令介面如何執行之功能的工作所需的權限。
...
<tbody>
<tr class="odd">
<td><p>Active Directory 網域服務伺服器設定</p></td>
<td><p><a href="organization-management-exchange-2013-help.md">組織管理</a></p>
...
<tr class="even">
<td><p>Cmdlet 延伸代理程式</p></td>
<td><p><a href="organization-management-exchange-2013-help.md">組織管理</a></p></td>
</tr>
<tr class="odd">
<td><p>PowerShell 虛擬目錄</p></td>
<td><p><a href="organization-management-exchange-2013-help.md">組織管理</a></p>
<p><a href="server-management-exchange-2013-help.md">伺服器管理</a></p></td>
</tr>
<tr class="even">
<td><p>PowerShell 和 WinRM 安裝</p></td>
...
下表列出在執行同盟信任、OAuth 組織、憑證管理和混合部署組態的相關工作時所需的權限。
...
<tr class="even">
<td><p>同盟信任 OAuth</p></td>
<td><p><a href="organization-management-exchange-2013-help.md">組織管理</a></p></td>
</tr>
<tr class="odd">
<td><p>測試同盟信任 OAuth</p></td>
<td><p><a href="organization-management-exchange-2013-help.md">組織管理</a></p>
