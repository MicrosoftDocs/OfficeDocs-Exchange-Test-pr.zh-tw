---
title: '小組信箱角色: Exchange 2013 Help'
TOCTitle: 小組信箱角色
ms:assetid: b4591082-c4af-41bf-bbb1-ed2b931e62fb
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ657485(v=EXCHG.150)
ms:contentKeyID: 50474021
ms.date: 05/21/2018
...
`Team Mailboxes`管理角色可讓系統管理員定義一個或多個站台信箱佈建原則並管理組織中的站台信箱。指定給此角色的系統管理員可以管理它們不擁有的站台信箱。
