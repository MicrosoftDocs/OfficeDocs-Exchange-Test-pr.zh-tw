---
title: 'Org 市集應用程式角色: Exchange 2013 Help'
TOCTitle: Org 市集應用程式角色
ms:assetid: 137ee328-0bad-4911-a7bf-82da7678f246
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ673043(v=EXCHG.150)
ms:contentKeyID: 50472601
ms.date: 05/21/2018
