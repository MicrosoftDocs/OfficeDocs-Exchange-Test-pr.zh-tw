---
title: 'WorkloadManagement 角色: Exchange 2013 Help'
TOCTitle: WorkloadManagement 角色
ms:assetid: d5c90eae-95c3-44b0-add5-a97337d17743
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ657498(v=EXCHG.150)
ms:contentKeyID: 50474287
ms.date: 05/21/2018
...
`WorkloadManagement`管理角色可讓系統管理員管理工作負載管理原則。系統管理員可以設定資源健康情況定義、 工作負載分類及啟用或停用工作負載管理。僅應依據 Microsoft 客戶服務與支援部門的進行變更。
