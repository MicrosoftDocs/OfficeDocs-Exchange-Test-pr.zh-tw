---
title: '組織傳輸設定角色: Exchange 2013 Help'
TOCTitle: 組織傳輸設定角色
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50474670
ms.date: 05/21/2018
...
`Organization Transport Settings`管理角色讓系統管理員可以管理整個組織的傳輸設定，例如整個 Exchange 組織的系統郵件、Active Directory 站台組態以及傳輸組態設定。

此角色不會讓您建立及管理傳送或接收連接器、 佇列、 檢疫、 代理程式、 遠端和公認的網域或規則。建立及管理每個傳輸功能，您必須具有一或多個下列角色：
