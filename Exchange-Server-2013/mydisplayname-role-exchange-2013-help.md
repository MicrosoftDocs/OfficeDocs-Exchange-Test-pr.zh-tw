---
title: 'MyDisplayName 角色: Exchange 2013 Help'
TOCTitle: MyDisplayName 角色
ms:assetid: d78d0032-29af-476b-82e3-69364ca7f12f
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Ff461938(v=EXCHG.150)
ms:contentKeyID: 50474319
ms.date: 05/21/2018
...
`MyDisplayName`管理角色可讓個別使用者檢視和修改其顯示名稱。這是從[MyProfileInformation 角色](myprofileinformation-role-exchange-2013-help.md)父系角色建立自訂角色。
