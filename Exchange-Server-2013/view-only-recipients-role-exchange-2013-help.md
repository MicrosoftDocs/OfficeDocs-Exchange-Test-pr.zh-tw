---
title: '僅檢視收件者角色: Exchange 2013 Help'
TOCTitle: 僅檢視收件者角色
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50472971
ms.date: 05/21/2018
...
`View-Only Recipients` 管理角色可讓系統管理員檢視收件者的組態，例如信箱、郵件使用者、郵件連絡人、通訊群組以及動態通訊群組。

此角色可以結合與建立能夠檢視組織中的每個物件的角色群組的`View-Only Configuration`角色相關聯的角色。如需詳細資訊，請參閱[僅檢視設定角色](view-only-configuration-role-exchange-2013-help.md)。
