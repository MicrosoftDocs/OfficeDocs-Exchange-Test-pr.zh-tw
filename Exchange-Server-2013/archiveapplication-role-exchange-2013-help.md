---
title: 'ArchiveApplication 角色: Exchange 2013 Help'
TOCTitle: ArchiveApplication 角色
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 50472704
ms.date: 05/21/2018
...
`ArchiveApplication` 管理角色將啟動協力廠商應用程式以於使用者信箱中封存項目。
