---
title: '支援診斷角色: Exchange 2013 Help'
TOCTitle: 支援診斷角色
ms:assetid: 3ad2c628-019e-4eb7-af43-64ab2a3a2fbf
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876875(v=EXCHG.150)
ms:contentKeyID: 50472991
ms.date: 05/21/2018
...
`Support Diagnostics` 管理角色可讓系統管理員在 Microsoft 客戶服務及支援的指示下，於組織中執行進階診斷。
...
<tbody>
<tr class="odd">
<td>此角色授與只應在客戶服務和支援的指示下使用之指令程式和指令碼的權限。</td>
</tr>
</tbody>
</table>
