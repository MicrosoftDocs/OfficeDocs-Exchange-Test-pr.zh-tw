---
title: 'MyAddressInformation 角色: Exchange 2013 Help'
TOCTitle: MyAddressInformation 角色
ms:assetid: b1be0e3d-53b9-4810-a225-3d0b203d90d4
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Ff461936(v=EXCHG.150)
ms:contentKeyID: 50474006
ms.date: 05/21/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# MyAddressInformation 角色
...
`MyAddressInformation`管理角色可讓個別使用者檢視和修改其街道地址和運作電話和傳真號碼。這是從[MyContactInformation 角色](mycontactinformation-role-exchange-2013-help.md)父系角色建立自訂角色。
