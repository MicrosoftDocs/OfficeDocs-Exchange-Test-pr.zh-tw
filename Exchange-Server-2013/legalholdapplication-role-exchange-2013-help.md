---
title: 'LegalHoldApplication 角色: Exchange 2013 Help'
TOCTitle: LegalHoldApplication 角色
ms:assetid: 8ac0e939-14fe-4f64-9fae-ea5767bd1e2c
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ657468(v=EXCHG.150)
ms:contentKeyID: 50473658
ms.date: 05/21/2018
...
`LegalHoldApplication` 管理角色可讓夥伴應用程式設定和檢視信箱的合法持有狀態。
