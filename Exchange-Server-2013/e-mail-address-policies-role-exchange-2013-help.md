---
title: '電子郵件地址原則角色: Exchange 2013 Help'
TOCTitle: 電子郵件地址原則角色
ms:assetid: d272e672-81ea-417c-b5d6-76a5efd5c036
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876944(v=EXCHG.150)
ms:contentKeyID: 50474273
ms.date: 05/21/2018
...
`E-Mail Address Policies` 管理角色可讓系統管理員管理組織中的電子郵件地址原則。
