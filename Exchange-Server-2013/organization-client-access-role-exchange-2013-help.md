---
title: '組織用戶端存取角色: Exchange 2013 Help'
TOCTitle: 組織用戶端存取角色
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50474692
ms.date: 05/21/2018
...
`Organization Client Access` 管理角色可讓系統管理員管理組織中的 Client Access Server 設定。
