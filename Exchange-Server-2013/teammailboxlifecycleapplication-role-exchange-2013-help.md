---
title: 'TeamMailboxLifecycleApplication 角色: Exchange 2013 Help'
TOCTitle: TeamMailboxLifecycleApplication 角色
ms:assetid: 3cd2cd6f-65e1-4e66-a017-054060c46fe1
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 50472995
ms.date: 05/21/2018
...
`TeamMailboxLifecycleApplication` 管理角色將啟動協力廠商應用程式來更新信箱生命週期狀態。
