---
title: 'UM 信箱角色: Exchange 2013 Help'
TOCTitle: UM 信箱角色
ms:assetid: 6c9442dc-e674-4474-888e-e2f391a8eb57
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876901(v=EXCHG.150)
ms:contentKeyID: 50473406
ms.date: 05/21/2018
...
`UM Mailboxes`管理角色可讓系統管理員管理整合通訊設定的信箱和其他組織中的收件者。
