---
title: '傳輸代理程式角色: Exchange 2013 Help'
TOCTitle: 傳輸代理程式角色
ms:assetid: 1679402e-158f-4630-8ef1-01ab5c7ce811
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876853(v=EXCHG.150)
ms:contentKeyID: 50472630
ms.date: 05/21/2018
...
`Transport Agents` 管理角色能讓系統管理員管理在組織中的傳輸代理程式。
