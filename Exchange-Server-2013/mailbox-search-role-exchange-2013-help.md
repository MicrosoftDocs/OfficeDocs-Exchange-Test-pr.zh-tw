---
title: '信箱搜尋角色: Exchange 2013 Help'
TOCTitle: 信箱搜尋角色
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 50474625
ms.date: 05/21/2018
...
`Mailbox Search` 管理角色可讓系統管理員搜尋組織中一或多個信箱的內容。
