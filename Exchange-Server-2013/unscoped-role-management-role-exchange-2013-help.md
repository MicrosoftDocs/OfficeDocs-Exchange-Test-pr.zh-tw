---
title: '未限定範圍的角色管理角色: Exchange 2013 Help'
TOCTitle: 未限定範圍的角色管理角色
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50474312
ms.date: 05/21/2018
...
`Unscoped Role Management` 管理角色可讓系統管理員在組織中建立及管理未限定範圍的頂層管理角色。
