---
title: '日誌記錄角色: Exchange 2013 Help'
TOCTitle: 日誌記錄角色
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 50473353
ms.date: 05/21/2018
...
`Journaling`管理角色可讓系統管理員建立、 修改、 啟用、 停用、 檢視和移除組織中的日誌規則。
