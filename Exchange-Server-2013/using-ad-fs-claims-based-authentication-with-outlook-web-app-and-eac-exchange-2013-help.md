...
12. 在 <strong>\[選擇發行授權規則\]</strong> 頁面上，選取 <strong>\[允許所有使用者存取此信賴憑證者\]</strong>，然後按 <strong>\[下一步\]</strong>。
...
3.  在 <strong>\[遠端存取管理\]</strong> 主控台的中間窗格中，按一下 <strong>\[執行 Web 應用程式 Proxy 組態精靈\]</strong>。
