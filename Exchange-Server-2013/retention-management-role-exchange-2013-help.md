---
title: '保留管理角色: Exchange 2013 Help'
TOCTitle: 保留管理角色
ms:assetid: ef16b495-c424-4ded-b5da-304e69ce31bb
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876953(v=EXCHG.150)
ms:contentKeyID: 50474556
ms.date: 05/21/2018
...
`Retention Management` 管理角色可讓系統管理員管理組織中的保留原則。
