---
title: '遠端和公認的網域角色: Exchange 2013 Help'
TOCTitle: 遠端和公認的網域角色
ms:assetid: 340c7546-5236-4743-a2b3-3c2363f3da1d
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876869(v=EXCHG.150)
ms:contentKeyID: 50472945
ms.date: 05/21/2018
...
`Remote and Accepted Domains` 管理角色可讓系統管理員管理組織中的遠端和公認網域。
