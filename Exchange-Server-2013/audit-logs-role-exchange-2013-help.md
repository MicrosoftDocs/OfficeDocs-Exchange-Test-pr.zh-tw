---
title: '稽核記錄 」 角色: Exchange 2013 Help'
TOCTitle: 稽核記錄 」 角色
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50472850
ms.date: 05/21/2018
...
`Audit Logs` 管理角色可讓系統管理員設定組織中的系統管理員稽核記錄檔。
