---
title: '收件者原則角色: Exchange 2013 Help'
TOCTitle: 收件者原則角色
ms:assetid: 81c76e5d-bc57-4326-93ca-5e673c9aa85e
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876916(v=EXCHG.150)
ms:contentKeyID: 50473653
ms.date: 05/21/2018
...
`Recipient Policies`管理角色可讓系統管理員管理收件者原則，例如節流原則、 Microsoft Office Outlook Web App信箱原則，以及組織中的行動裝置原則。
