---
title: '傳輸佇列角色: Exchange 2013 Help'
TOCTitle: 傳輸佇列角色
ms:assetid: f663005a-4cb0-4c52-9c95-58681fc5eaab
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876955(v=EXCHG.150)
ms:contentKeyID: 50474612
ms.date: 05/21/2018
...
`Transport Queues` 管理角色讓系統管理員可以管理個別傳輸伺服器的郵件佇列。
