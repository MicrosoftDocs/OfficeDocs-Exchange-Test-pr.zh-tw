---
title: '地址清單角色: Exchange 2013 Help'
TOCTitle: 地址清單角色
ms:assetid: 31143e30-16f5-45f5-b9a6-a39e6aa831d9
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876867(v=EXCHG.150)
ms:contentKeyID: 50472799
ms.date: 05/21/2018
...
`Address Lists` 管理角色可以讓系統管理員在組織中建立、修改、檢視以及移除通訊清單、全域通訊清單 (GAL) 、通訊錄原則以及離線通訊清單 (OAB)。
