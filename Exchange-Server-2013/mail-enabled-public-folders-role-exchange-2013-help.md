---
title: '擁有郵件功能的公用資料夾角色: Exchange 2013 Help'
TOCTitle: 擁有郵件功能的公用資料夾角色
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 50472700
ms.date: 05/21/2018
...
此角色可讓您管理僅公用資料夾的電子郵件屬性。它不會讓您管理電子郵件不相關的公用資料夾屬性。若要管理的電子郵件，請使用`Public Folders`角色不相關的公用資料夾內容。如需詳細資訊，請參閱[公用資料夾角色](public-folders-role-exchange-2013-help.md)。
