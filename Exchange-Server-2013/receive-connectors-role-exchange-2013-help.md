---
title: '接收連接器角色: Exchange 2013 Help'
TOCTitle: 接收連接器角色
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50473930
ms.date: 05/21/2018
...
`Receive Connectors` 管理角色可讓系統管理員管理傳輸「接收」連接器組態，例如個別伺服器上的大小限制。
