---
title: '整合的通訊角色: Exchange 2013 Help'
TOCTitle: 整合的通訊角色
ms:assetid: bf24aa04-5843-4cf3-83e7-3a5fa7bd3522
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876935(v=EXCHG.150)
ms:contentKeyID: 50474152
ms.date: 05/21/2018
...
`Unified Messaging` 角色可讓系統管理員管理組織中的整合通訊 (UM) 服務。

此角色不會讓您管理特定 UM 的信箱設定\] 或 \[UM 提示。若要管理 UM 特定信箱的設定，請使用`UM Mailboxes `角色相關聯的角色。若要管理 UM 提示，請使用`UM Prompts`角色相關聯的角色。如需詳細資訊，請參閱：
