---
title: '重設密碼角色: Exchange 2013 Help'
TOCTitle: 重設密碼角色
ms:assetid: d80101f1-7e3d-4a61-b93a-23da23e95e93
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ657499(v=EXCHG.150)
ms:contentKeyID: 50474336
ms.date: 05/21/2018
...
重設密碼管理角色能夠讓個別使用者重設自己的密碼，並且讓系統管理員重設組織中的使用者密碼。
