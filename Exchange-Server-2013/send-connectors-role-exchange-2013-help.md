---
title: '傳送連接器角色: Exchange 2013 Help'
TOCTitle: 傳送連接器角色
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 50473594
ms.date: 05/21/2018
...
`Send Connectors`管理角色可讓系統管理員管理傳輸組織內傳送連接器。
