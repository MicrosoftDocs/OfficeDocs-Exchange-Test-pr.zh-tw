---
title: 'Org 自訂應用程式角色: Exchange 2013 Help'
TOCTitle: Org 自訂應用程式角色
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 50473940
ms.date: 05/21/2018
...
組織自訂應用程式管理角色可讓系統管理員檢視及修改其組織的應用程式，以及從檔案或 URL 新增自訂應用程式。
