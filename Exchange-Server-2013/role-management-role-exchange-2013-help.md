---
title: '角色管理角色: Exchange 2013 Help'
TOCTitle: 角色管理角色
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50473475
ms.date: 05/21/2018
...
`Role Management`管理角色可讓系統管理員管理管理角色群組 ；角色指派原則和管理角色;與角色項目、 指派和組織中的範圍。

指定給此角色的使用者可以覆寫 role group managed by、 設定任何角色群組，並新增或移除任何角色群組的成員。
