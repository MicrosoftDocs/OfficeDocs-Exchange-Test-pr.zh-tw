---
title: '資料外洩防護角色: Exchange 2013 Help'
TOCTitle: 資料外洩防護角色
ms:assetid: 026d0e48-f4da-416e-a00d-794bd3b38c5c
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ673034(v=EXCHG.150)
ms:contentKeyID: 50472466
ms.date: 05/21/2018
...
資料外洩防護管理角色可讓系統管理員可以建立和管理資料外洩防護 (DLP) 原則和內，可能會影響整個組織的郵件傳遞的規則。此外，此角色提供系統管理員以設定原則提示出現在電子郵件用戶端和管理 DLP 原則違規報表的能力。此 DLP 角色也可讓Microsoft Exchange傳輸規則的存取。如需詳細資訊 Exchange 傳輸規則，請參閱下列主題：

  - [傳輸規則角色](transport-rules-role-exchange-2013-help.md)

  - [傳輸規則的新功能](what-s-new-for-transport-rules-exchange-2013-help.md)
