---
title: '移轉角色: Exchange 2013 Help'
TOCTitle: 移轉角色
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 50473660
ms.date: 05/21/2018
...
`Migration` 管理角色可讓系統管理員將信箱和信箱內容移入或移出伺服器。
