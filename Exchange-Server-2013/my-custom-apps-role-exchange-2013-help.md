---
title: '我自訂應用程式的角色: Exchange 2013 Help'
TOCTitle: 我自訂應用程式的角色
ms:assetid: aa0321b3-2ec0-4694-875b-7a93d3d99089
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/JJ657478(v=EXCHG.150)
ms:contentKeyID: 50473944
ms.date: 05/21/2018
...
我的自訂應用程式角色可讓個別使用者從檔案或 URL 新增應用程式。
