---
title: 'Exchange 伺服器角色: Exchange 2013 Help'
TOCTitle: Exchange 伺服器角色
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 50473226
ms.date: 05/21/2018
...
`Exchange Servers` 管理角色可讓系統管理員在個別伺服器上執行下列動作：

  - 新增並移除資料庫可用性群組並設定資料庫複本

  - 啟用、停用與設定整合通訊服務

  - 修改信箱與用戶端存取伺服器上的傳輸組態

  - 啟用和停用用戶端存取伺服器上的 Microsoft Outlook Anywhere

  - 信箱與用戶端存取伺服器組態

  - 修改用戶端存取伺服器上的 Outlook Anywhere 組態
