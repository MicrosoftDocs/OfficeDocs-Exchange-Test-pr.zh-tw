---
title: '監視角色: Exchange 2013 Help'
TOCTitle: 監視角色
ms:assetid: ba4cb787-8e17-4565-bccd-74e846c06a4f
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876933(v=EXCHG.150)
ms:contentKeyID: 50474053
ms.date: 05/21/2018
...
監控管理角色可讓系統管理員可以監視Exchange服務和元件在組織中的可用性。此角色也可以搭配藉由監視應用程式用來收集執行Exchange伺服器的狀態資訊的服務帳戶。
