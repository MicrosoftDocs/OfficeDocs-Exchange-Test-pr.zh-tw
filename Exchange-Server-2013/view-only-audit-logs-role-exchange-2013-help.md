---
title: '僅檢視稽核記錄 」 角色: Exchange 2013 Help'
TOCTitle: 僅檢視稽核記錄 」 角色
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 50473765
ms.date: 05/21/2018
...
`View-Only Audit Logs` 管理角色可讓系統管理員和專家使用者搜尋組織中的系統管理員稽核記錄。
