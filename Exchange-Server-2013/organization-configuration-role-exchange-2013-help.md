---
title: '組織設定角色: Exchange 2013 Help'
TOCTitle: 組織設定角色
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50474424
ms.date: 05/21/2018
...
`Organization Configuration`管理角色可讓系統管理員管理整個組織設定。可控制與此角色的組織組態包括下列及其他：
  ...
  - Microsoft Exchange 收件者 SMTP 地址和備用電子郵件地址

  - 資源信箱屬性結構描述組態

  - Exchange 系統管理中心及 Microsoft Office Outlook Web App 的說明 URL

此角色類型不包括 `Organization Client Access` 或 `Organization Transport Settings` 角色中包含的權限。
