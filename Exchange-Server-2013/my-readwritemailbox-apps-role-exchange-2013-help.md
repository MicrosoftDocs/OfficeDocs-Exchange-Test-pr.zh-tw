---
title: '我 ReadWriteMailbox 應用程式的角色: Exchange 2013 Help'
TOCTitle: 我 ReadWriteMailbox 應用程式的角色
ms:assetid: febb73fb-3a0b-4c67-b53b-9566d7c32cd2
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Mt793556(v=EXCHG.150)
ms:contentKeyID: 74418160
ms.date: 05/21/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# 我 ReadWriteMailbox 應用程式的角色
