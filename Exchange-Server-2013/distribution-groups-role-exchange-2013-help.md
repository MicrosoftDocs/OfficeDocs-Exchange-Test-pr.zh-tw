---
title: '通訊群組角色: Exchange 2013 Help'
TOCTitle: 通訊群組角色
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 50472540
ms.date: 05/21/2018
...
`Distribution Groups` 管理角色可讓系統管理員建立、修改、檢視和移除通訊群組，並新增或移除組織中的通訊群組成員。
