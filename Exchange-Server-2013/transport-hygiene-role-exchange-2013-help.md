---
title: '傳輸檢疫角色: Exchange 2013 Help'
TOCTitle: 傳輸檢疫角色
ms:assetid: 629792e4-7a8f-4447-b031-1c7d7c994b8a
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876893(v=EXCHG.150)
ms:contentKeyID: 50473306
ms.date: 05/21/2018
...
`Transport Hygiene`管理角色可讓系統管理員管理組織中的反垃圾郵件和反惡意程式碼功能。
