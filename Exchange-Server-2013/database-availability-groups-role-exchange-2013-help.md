---
title: '資料庫可用性群組角色: Exchange 2013 Help'
TOCTitle: 資料庫可用性群組角色
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/zh-tw/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 50472530
ms.date: 05/21/2018
...
`Database Availability Groups`管理角色可讓系統管理員管理組織中的資料庫可用性群組。系統管理員指定給此角色直接或間接的方式是最高的層級管理員負責規劃組織中的高可用性組態。
